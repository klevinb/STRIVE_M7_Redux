...
class StudentDetails extends Component {
  ...
  searchProjects = async () => {
    let resp = await fetch(
      "http://127.0.0.1:3003/projects?name=" + this.state.searchValue
    );
  ...
  getProjectPhoto = async (id) => {
    const resp = await fetch(
      "http://127.0.0.1:3003/projects/" + id + "/getPhoto"
    );
    if (resp.ok) {
      this.setState({
        photo: resp.url,
  ...
  fetchUser = async () => {
    let resp = await fetch(
      "http://127.0.0.1:3003/students/" + this.props.match.params.id
    );
    let data = await resp.json();
    if (resp.ok) {
      this.setState({
  ...
  fetchReviews = async (id) => {
    const resp = await fetch(
      "http://127.0.0.1:3003/projects/" + id + "/reviews"
    );
  ...
  editProjectInfo = async (e) => {
    ...
    let resp = await fetch(
      "http://127.0.0.1:3003/projects/" + this.state.projectID,
      {
        method: "PUT",
    ...
    const resp2 = await fetch(
      "http://127.0.0.1:3003/projects/" + this.state.projectID + "/uploadPhoto",
      {
        method: "POST",
        body: data,
      }
  ...
  addProjectFunction = async (e) => {
    ...
    const resp2 = await fetch(
      "http://127.0.0.1:3003/projects/" + projectId._id + "/uploadPhoto",
      {
        method: "POST",
        body: data,
      }
  ...
  addNewReview = async (e) => {
    e.preventDefault();
    const resp = await fetch(
      "http://127.0.0.1:3003/projects/" + this.state.projectId + "/reviews",
      {
        method: "POST",
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey='1'>
                <>
                  <Card.Body>
                    <TableForProjects
                      projects={this.state.user && this.state.user.projects}
